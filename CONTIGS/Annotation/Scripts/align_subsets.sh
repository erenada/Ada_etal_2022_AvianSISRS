...
listOfData=$(cat /data/schwartzlab/eren/Chapter1/CONTIGS/Annotation/annot_table_all.csv | tail -n +2 | cut -f 2 | sort | uniq)
PTH=(/data/schwartzlab/eren/Chapter1/CONTIGS/Annotation)
PTH_OUT=(/data/schwartzlab/eren/Chapter1/CONTIGS/Annotation/ALIGNED)

for type in $listOfData;
do
  mkdir /data/schwartzlab/eren/Chapter1/CONTIGS/Annotation/ALIGNED/${type}
