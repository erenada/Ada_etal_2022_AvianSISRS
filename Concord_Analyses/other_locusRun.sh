...
#SBATCH -o other_loci_%A.out
#SBATCH -e other_loci_%A.err
#SBATCH --exclusive
...
/data/schwartzlab/eren/programs/iqtree-2.1.3-Linux/bin/iqtree2 -nt AUTO -s ${ALN_DIR}/other/other_concat.fasta -S ${ALN_DIR}/other/other_partition.txt --prefix other_loci
