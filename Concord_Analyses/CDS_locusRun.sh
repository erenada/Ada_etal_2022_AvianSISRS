...
#SBATCH -o CDS_loci_%A.out
#SBATCH -e CDS_loci_%A.err
#SBATCH --exclusive
...
/data/schwartzlab/eren/programs/iqtree-2.1.3-Linux/bin/iqtree2 -nt AUTO -s ${ALN_DIR}/CDS/CDS_concat.fasta -S ${ALN_DIR}/CDS/CDS_partition.txt --prefix CDS_loci
