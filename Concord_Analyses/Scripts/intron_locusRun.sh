...
#SBATCH -o intron_loci_%A.out
#SBATCH -e intron_loci_%A.err
#SBATCH --exclusive
...
/data/schwartzlab/eren/programs/iqtree-2.1.3-Linux/bin/iqtree2 -nt AUTO -s ${ALN_DIR}/intron/intron_concat.fasta -S ${ALN_DIR}/intron/intron_partition.txt --prefix intron_loci
