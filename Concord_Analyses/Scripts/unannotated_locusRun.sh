...
#SBATCH -o unannotated_loci_%A.out
#SBATCH -e unannotated_loci_%A.err
#SBATCH --exclusive
...
/data/schwartzlab/eren/programs/iqtree-2.1.3-Linux/bin/iqtree2 -nt AUTO -s ${ALN_DIR}/unannotated/unannotated_concat.fasta -S ${ALN_DIR}/unannotated/unannotated_partition.txt --prefix unannotated_loci
